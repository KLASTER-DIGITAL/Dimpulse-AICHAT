  ...
  useEffect(() => {
    ...
    const processContent = (content: string) => {
      ...
      if (content.includes('Cal(') && content.includes('function')) {
        // For Cal.com integration, use the complete code directly but with a unique ID
        console.log("Cal.com integration detected, using complete HTML with unique ID");
        return `
          <div style="width:100%;height:600px;overflow:auto" id="${uniqueId}"></div>
