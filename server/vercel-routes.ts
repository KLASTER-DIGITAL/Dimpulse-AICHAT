...
function generateAssistantResponse(userMessage: string): string {
  ...
  if (userMessage.toLowerCase().includes('консультац')) {
    return "Для записи на консультацию, пожалуйста, выберите удобное время в календаре: <div class='calendar-container' id='cal-embed-" + 
           randomUUID().slice(0, 8) + "'><iframe src='https://cal.com/demo/30min' width='100%' height='600' frameborder='0'></iframe></div>";
  }
